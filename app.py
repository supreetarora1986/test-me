...
def evaluate(reply, message, history, gemini, summary, profile, name):
...
def rerun(reply, message, history, feedback, system_prompt, gemini):
...
If you don't know the answer, say so."
    ...
    def chat(message, history):
        ...
        evaluation = evaluate(reply, message, history, gemini, summary, profile, name)
        if evaluation.is_acceptable:
            print("Passed evaluation - returning reply")
        else:
            print("Failed evaluation - retrying")
            print(evaluation.feedback)
            reply = rerun(reply, message, history, evaluation.feedback, system_prompt, gemini)
        return reply
